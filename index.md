...
<p>Updated at 2021-04-20</p>

<p> Investor social (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Investor social.</p>
<p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, Investor social. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.</p>
...
<p>To help explain things as clearly as possible in this Privacy Policy, every time any of these terms are referenced, are strictly defined as:
 <ul>
   ...
   <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to ARTHASHALA PRIVATE LIMITED, No. 458 Roopena Agrahara Bengaluru Bangalore KA 560068  that is responsible for your information under this Privacy Policy.</li>
   <li>Country: where Investor social or the owners/founders of Investor social are based, in this case is IN</li>
   <li>Customer: refers to the company, organization or person that signs up to use the Investor social Service to manage the relationships with your consumers or service users.</li>
   <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Investor social and use the services.</li>
   ...
   <li>Personnel: refers to those individuals who are employed by Investor social or are under contract to perform a service on behalf of one of the parties.</li>
   ...
   <li>Service: refers to the service provided by Investor social as described in the relative terms (if available) and on this platform.</li>
   ...
   <li>Website: Investor social's site, which can be accessed via this URL: </li>
   <li>You: a person or entity that is registered with Investor social to use the Services.</li>
 </ul>
</p>
...
<ul><li>Name / Username</li><li>Email Addresses</li>
  ...
  <p>We also collect information from mobile devices for a better user experience, although these features are completely optional:</p><ul><li>Camera (Pictures): Granting camera permission allows the user to upload any picture straight from the app, you can safely deny camera permissions for this app.</li>
  </ul>
...
<h1>When does Investor social use end user information from third parties?</h1>
<p>Investor social will collect End User Data necessary to provide the Investor social services to our customers.</p>
...
<p>Investor social will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
...
<p>The rights you have to request updates or corrections to the information Investor social collects depend on your relationship with Investor social. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
...
<h1>Personnel</h1>
<p>If you are a Investor social worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
...
<p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Investor social or any of its Corporate Affiliates (as defined herein), or that portion of Investor social or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

<h1>Affiliates</h1>
<p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with Investor social, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
...
<ul><li>Via Email:  <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e89b9d9898879a9ca881869e8d9b9c879a9b878b818984c6899898">[email&#160;protected]</a></li>
